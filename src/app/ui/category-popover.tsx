...
export default function AddCategoryPopOver() {
  return (
    <div id="add-category-popover" className="absolute top-full left-0 mt-3 bg-white border border-gray-200 rounded-lg shadow-xl z-10 w-max">
      ...
      <form id="add-category-form" className="p-4">
        ...
        <div className="flex flex-row">
          ...
          <button type="button" className="bg-blue-600 text-white font-semibold px-4 py-1.5 rounded-md hover:bg-blue-700 transition-colors text-sm ml-1 w-max">追加</button>
        </div>
      </form>
    </div>
  );
